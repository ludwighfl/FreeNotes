...
class HighlightItem(QGraphicsItem, IPathScalable):
    ...
    def paint(
        ...
        # Selection frame is managed centrally by SelectionBoxItem overlay
    ...
    def restore_state(self, state: dict) -> None:
        ...
        if "width" in state and state["width"] > 0:
            self._style.width = state["width"]
        self._cached_br = None
        self.update()
